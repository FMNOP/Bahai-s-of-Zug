...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      page_title: "Bahá'í Community of Zug | Building Unity & Community",
      admin_logged_banner: "Logged in as Admin (Canton Zug Portal)",
      logout_btn: "Logout",
      logo_text: "BAHÁ'Í COMMUNITY OF ZUG",
      nav_beliefs: "Beliefs",
      ...
      milestone_desc_short_2: "'Abdu'l-Bahá, the son of the Faith's founder, visits Switzerland for a period of rest and informal gatherings.",
      milestone_details_2: "In September 1911, 'Abdu'l-Bahá visited Geneva and Thonon-les-Bains. This period was primarily dedicated to rest after his exhausting journey from Egypt. Rather than public lectures, he held intimate, informal meetings with early Western Bahá'ís and individual seekers who visited him.",
      milestone_title_3: "Italo-Swiss Assembly",
      milestone_desc_short_3: "The election of the joint Italo-Swiss regional assembly coordinates activities across both countries.",
      milestone_details_3: "In 1953, the first joint regional administrative body, the Italo-Swiss National Spiritual Assembly, was elected. This assembly coordinated activities across both Italy and Switzerland, laying the groundwork for stronger local communities.",
      milestone_title_4: "Swiss National Assembly",
      milestone_desc_short_4: "Switzerland elects its independent standalone National Spiritual Assembly, based in Bern.",
      milestone_details_4: "In 1962, during the global Ten Year Crusade, the independent, sovereign National Spiritual Assembly of the Bahá'ís of Switzerland was officially established. This marked the official administrative autonomy of the Swiss Bahá'í community, with its permanent seat in Bern.",
      milestone_title_5: "Zug Community Activities",
      milestone_desc_short_5: "Active local groups hosting activities for all ages, contributing to character education and service in Canton Zug.",
      milestone_details_5: "Today, the Zug community consists of local Bahá'ís and friends from diverse national origins, actively engaged in building peaceful neighborhoods, hosting moral classes for kids in Cham, Baar, and Zug, and organising community devotionals.",
    ...
    de: {
      page_title: "Bahá'í-Gemeinde Zug | Aufbau von Einheit & Gemeinschaft",
      admin_logged_banner: "Als Administrator angemeldet (Kanton Zug Portal)",
      logout_btn: "Abmelden",
      logo_text: "BAHÁ'Í-GEMEINDE ZUG",
      nav_beliefs: "Lehren",
      ...
      beliefs_subtitle: "Die Lehren des Bahá'í-Glaubens inspirieren Einzelpersonen und Familien in Zug dazu, zum geistigen und materiellen Fortschritt der Gesellschaft beizutragen.",
      ...
      act_desc_2: "Ein Raum für Teenager, um sich zu treffen, bedeutende Themen (wie Medien, Gruppenzwang und Gerechtigkeit) zu besprechen, ihre Fähigkeiten zu entwickeln und gemeinnützige Projekte in der Nachbarschaft zu planen und durchzuführen.",
      act_details_2: "Das geistige Empowermentprogramm für Junioren unterstützt Jugendliche in einer entscheidenden Phase des Wachstums. Sie lernen, ihre Umgebung zu analysieren und geistige Prinzipien anzuwenden, um reale Probleme zu lösen.",
      act_badge_3: "Erwachsene & Familien",
      act_title_3: "Andachten",
      act_desc_3: "Einfache Treffen von Freunden und Nachbarn, um Gebete zu teilen, erbauliche Texte zu lesen und Musik zu genießen. Ein friedlicher Raum zur Besinnung und zum Austausch.",
      act_details_3: "Andachtsversammlungen haben kein formelles Ritual. Gäste sind herzlich eingeladen, Gebete oder Schriften aus der eigenen Religion zu teilen, oder einfach die friedliche Atmosphäre zu genießen.",
      ...
      virtue_badge: "Interaktive Tugendkarte",
      virtue_title: "Entdecken Sie Ihre Tugend des Tages.",
      virtue_subtitle: "Charakterbildung steht im Mittelpunkt der Bahá'í-Gemeinschaft. Unser Tugendkartengenerator bietet eine spielerische Möglichkeit für Kinder, Eltern und Lehrende, gemeinsam über positive Eigenschaften nachzudenken.",
      ...
      virtue_card_desc_init: "Jeder Tag bietet die Gelegenheit, positive Eigenschaften zu entfalten. Klicken Sie auf „Eine Tugend enthüllen“, um zu sehen, wie Sie heute Güte, Geduld, Einheit oder Gerechtigkeit in die Tat umsetzen können.",
      virtue_card_quote_init: '"Wahrer Friede kann nur kommen, wenn wir lernen, allen Menschen Liebe und Gerechtigkeit entgegenzubringen."',
      ...
      virtue_footer_2: "Gemeinsam wachsen",
      ...
      milestone_desc_short_1: "Die Anfänge des Glaubens in der Schweiz gehen auf frühe Denker zurück, welche die Lehren von Einheit und Frieden kennenlernten.",
      ...
      milestone_desc_short_2: "'Abdu'l-Bahá, der Sohn des Stifters des Glaubens, besucht die Schweiz für eine Zeit der Erholung und informeller Treffen.",
      milestone_details_2: "Im September 1911 besuchte 'Abdu'l-Bahá Genf und Thonon-les-Bains. Diese Zeit war hauptsächlich der Erholung nach seiner anstrengenden Reise aus Ägypten gewidmet. Anstelle von öffentlichen Vorträgen hielt er persönliche, informelle Treffen mit frühen westlichen Bahá'í und einzelnen Suchenden ab, die ihn besuchten.",
      milestone_title_3: "Italo-Schweizerischer Rat gebildet",
      milestone_desc_short_3: "Die Wahl der ersten gemeinsamen regionalen Versammlung koordiniert Aktivitäten in beiden Ländern.",
      milestone_details_3: "Im Jahr 1953 wurde der erste gemeinsame administrative Rat, der Nationale Geistige Rat der Bahá'í von Italien und der Schweiz, gewählt. Dies legte das Fundament für eine geordnete Entwicklung der Aktivitäten in der Region.",
      milestone_title_4: "Eigenständiger Nationaler Rat (1962)",
      milestone_desc_short_4: "Die Schweiz wählt ihren eigenen eigenständigen Nationalen Geistigen Rat mit Sitz in Bern.",
      milestone_details_4: "Im Jahr 1962 wurde der eigenständige Nationale Geistige Rat der Bahá'í der Schweiz offiziell gewählt. Dies markierte die administrative Autonomie der Schweizer Bahá'í-Gemeinde, mit dem dauerhaften Sitz der nationalen Kanzlei in Bern.",
      milestone_title_5: "Aktivitäten der Zuger Gemeinde",
      milestone_desc_short_5: "Aktive lokale Gruppen organisieren Aktivitäten für jedes Alter und tragen zur Charakterbildung und zum Gemeindedienst im Kanton Zug bei.",
      milestone_details_5: "Heute besteht die Zuger Gemeinschaft aus lokalen Bahá'í und Freunden unterschiedlicher Herkunft, die sich aktiv für den Aufbau friedlicher Nachbarschaften einsetzen, Kinderklassen in Cham, Baar und Zug leiten und Andachten veranstalten.",
